...
from Training.cohort_loader import *
...
if __name__ == '__main__':
    ...
    ## Build Dataset 
    print(f'Build Dataset : {args.hirid_data_dir} ....')
    ...
    loader_train = DataLoader(dataset_train, batch_size=args.batch_size, shuffle=True, sampler=sampler, drop_last=True)
    ...
    def train(trial, search = False):
        ...
        wandb.init(name=f'Ftt-training: {lr}',
        ...
        # model define
        emb_model = FTTransformer(categories=card_categories,
        ...
        for epoch in range(1, total_epoch+1):
            ...
            if avg_valid_loss < Best_valid_loss:
                ...
                early_stop_counter = 0
                torch.save(emb_model.state_dict(),f'{args.ckpt_dir}/FTTransformer_pattern.pth')
    ...
    if args.mode == "train":
        dataset_val = TrainingDataset(data_path=args.mimic_data_dir, data_type='mimic',mode='valid',seed=args.seed)
